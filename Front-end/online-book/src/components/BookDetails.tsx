        ...
        <div className="space-y-6">
          ...
          <div className="space-y-5 pt-2">
            <div className="flex items-center gap-4">
              ...
              {/* ✅ Quantity Selector: සයිස් එක අඩු කළා (h-10) */}
              <div className="flex items-center border-2 rounded-lg overflow-hidden bg-muted/30">
                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-none hover:bg-background" onClick={decreaseQty}>
                  <Minus className="h-4 w-4" />
                </Button>
                <div className="w-10 text-center font-bold text-base">{quantity}</div>
                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-none hover:bg-background" onClick={increaseQty}>
